...
def process(downloads_path):
    ...
    # Check if any of the supported file extensions is in the filename
    supported_extensions = ['.zip', '.7z']
    zipped_downloads = [f for f in os.listdir(downloads_path) if any(ext in f for ext in supported_extensions)]
